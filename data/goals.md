...
#### 選項 C：重心放 LEX，**年底（2026-12）從工研院離職**（2026-08-21 使用者提出）

**這個選項的價值在於它不是立刻二選一，而是保留 4 個月緩衝**（2026-09 → 12），時間上也剛好接得起來：LEX 半年計畫約 2026-09 → 2027-02，離職後正好全力衝期末。

**⚠️ 但順序不能顛倒**：**先確認 LEX 真的落地，再談離職。** 目前 LEX 還有三個未解問題（誰保證資料可發表／誰指導／計畫的正式身分）。**在那之前離職 ＝ 兩頭空的風險。**

正確順序：`LEX 三題有答案` → `論文重心轉移` → `年底離職`

**建議把它定義成「年底檢查點」而不是「已決定離職」**，到 2026-11 底依實際狀況判斷：

| 檢查項目 | 若「是」→ 傾向離職專心 LEX | 若「否」→ 傾向留任 |
|---|---|---|
| LEX 資料到手、教授實質指導、有發表進度 | ✅ | ❌ |
| G1 到貨了嗎 | 沒到 → 離職 | **到了 → 留**（實機經驗難得，且第 10 項可完成） |
| ITRI 分工明確了嗎、chatbox 有進展嗎 | 沒有 → 離職 | 有 → 留 |
| 哪邊的論文素材較紮實 | LEX → 離職 | ITRI → 留 |

**離職前一定要做的事（無論最後走哪條）**：**把 ITRI 的成果收尾成可展示的作品集**——合成資料 pipeline、YOLO 辨識、RMPflow reach demo、（若有）chatbox 最小可行版，整理成 demo 影片＋README＋數據。**這是職涯 T1 的核心資產，不能因為離職就散掉。**

**⬜ 離職這件事要先確認的四件事**：
1. 實習**是否有薪**、離職的財務影響
2. 是否**綁約**（計畫期限、提前離開的規定）
3. 工研院經歷**做滿一年 vs 半年**在履歷上的差別
4. 離職後**還能不能用 ITRI 的資料與成果寫論文**（授權問題，與 LEX 是同一類問題）

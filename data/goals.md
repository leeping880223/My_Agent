...
1. **指導品質**——Basanta 是 LEX 的計畫主持人，而他**確實有在指導**：建議有用、用心，認可使用者的報告能力與切入角度，也肯定「從痛點出發」的做法。相較之下，機器人那層他無法判斷「做到哪算夠」，也無力在口試替你辯護。
...
| # | 要確認的事 | 不成立的話 |
|---|---|---|
| 1 | **前一期案子的資料狀態**——有沒有標註？量夠不夠？瑕疵樣本比例多低？ | 資料若也很殘，LEX 的最大優勢消失，回頭重估 ITRI |

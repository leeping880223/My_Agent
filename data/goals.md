...
**要不要提 LEX？會自然講到（第 11、12 題一問，對方一定反問「你要發表什麼」），但講多少要控制。**

| ✅ 要講 | ❌ 不用講 |
|---|---|
| 我在準備碩士論文，想確認這邊的成果能不能寫進去 | LEX 是哪家公司、做什麼題目 |
| 我教授那邊 9 月初也有一個計畫要開會，兩邊都在看 | 教授是那個計畫的主持人 |
| | 我在比較哪個比較好畢業 |

細節多講會讓它從「**我在規劃論文**」變成「**我在比價**」——前者是資訊，後者是議價，而實習生的議價籌碼不大，硬議反而扣分。

**可以直接用的說法**：「我在準備碩士論文，想確認這邊的成果能不能寫進去、發表的範圍大概是什麼。我教授那邊 9 月初也有另一個計畫要開會，所以我想先把兩邊的狀況都弄清楚再決定方向。」

⭐ **時機：放在最後，不要一開場就講。** 順序＝**報告 → 問 A/B/C 組技術題 → 提案 → 最後問 D 組時才帶出這句**。放在最後它是「解釋我為什麼問授權」；放在開場它是「我先聲明我有別的選項」。**同一句話，位置不同，聽起來完全不一樣。**

**對 ITRI 來說，你的論文寫什麼關係不大**——他們要的是實習工作做好，而你本來就做到 12 月。所以訊息是「我論文可能寫別的」，不是「我可能不來了」。**若最後選 LEX，也不用特別去講，實習照常做完即可。**

...
| | 適合當什麼 | 理由 |
|---|---|---|
| **LEX**（2027-01→06） | **發表**（滿足畢業門檻） | 教授主持、能實質指導、資料可發表 |
| **ITRI 機器人**（2026-09→12） | **論文主體 ＋ 履歷專案** | 現在就能做、資源在手、**職涯 T1 對口**（達明／台達／Solomon） |

**這個分工的好處**：論文的研究期落在 2026 下半年（有東西可做），2027 上半年專心寫作 ＋ LEX ＋ 投稿，時程才鬆得開。反過來（LEX 當論文主體）會把所有事情擠進 2027 上半年。

**⬜ 決定這個分工成不成立的問題：預計什麼時候口試／畢業？**
- 2027 年中畢業 → **論文主體必須是 ITRI**，LEX 只能當發表與履歷
- 2027 年底以後畢業 → LEX 才有機會當論文主體

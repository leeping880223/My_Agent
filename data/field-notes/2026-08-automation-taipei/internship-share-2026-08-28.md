...
分享人：李丙軒｜參觀日期：2026-08-19、08-20｜地點：南港展覽館
...
**⚠️ 待確認**：我在現場看到的 Solomon 是**文字輸入**（螢幕上的 AI Chat）。他們是否也支援語音輸入，我沒有確認到——這點若要寫進正式資料，需要再跟原廠查證。
...
2. **輸入方式建議做成語音＋文字雙軌**：語音是給人看的亮點，文字是實際環境下的保險。
